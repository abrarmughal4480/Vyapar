    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-1 sm:p-2">
      ...
      <div className="w-full h-auto bg-white/90 rounded-2xl shadow-2xl border border-gray-100 overflow-hidden mx-auto my-1 sm:my-3">
        ...
        <form onSubmit={handleSubmit} className="divide-y divide-gray-200 w-full">
          ...
          {/* Items Table Section */}
          <div className={`bg-white px-2 sm:px-4 py-6 w-full rounded-b-2xl ${formErrors.items ? 'border-2 border-red-300' : ''}`}>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (index === newCreditNote.items.length - 1 && newQty > 0) {
                            addNewRow();
                          }
                        }}
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <span className="ml-2 text-sm font-semibold text-gray-900">
                        PKR {isNaN(item.amount) ? '0.00' : item.amount.toFixed(2)}
                      </span>
                    </div>
                    {newCreditNote.items.length > 1 && (
                      <button
