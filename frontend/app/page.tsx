            ...
            <div className="w-full lg:w-[60%] text-center lg:text-left h-full flex flex-col justify-center space-y-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 mt-4 animate-fadeInUp">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-semibold text-gray-700">₨750Cr+</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-y-12 gap-x-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-white/80 backdrop-blur-lg rounded-2xl p-10 border border-emerald-200 shadow-xl transition-transform duration-300 hover:scale-105 hover:shadow-2xl animate-fadeInUp relative"
                style={{ animationDelay: `${index * 120 + 400}ms`, animationFillMode: 'both' }}
              >
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-emerald-100 rounded-full p-3 shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-7 h-7 text-emerald-500">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M7 17a4 4 0 01-4-4V7a4 4 0 014-4h2a4 4 0 014 4v6a4 4 0 01-4 4zm10 0a4 4 0 01-4-4V7a4 4 0 014-4h2a4 4 0 014 4v6a4 4 0 01-4 4z" />
                  </svg>
                </div>
                <div className="flex mb-4 mt-4 justify-center">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className={`w-5 h-5 ${i < testimonial.rating ? 'text-yellow-400 fill-current' : 'text-gray-200'}`} />
                  ))}
                </div>
